...
const Footer = props => (
  <footer id="footer">
    <section>
      <h2>More stuff</h2>
      <p>
        <a href="/skype">Skype lessons</a>
      </p>
      <p>
        <a href="/music-made-to-order">Music Made to Order</a>
      </p>
    ...
    <section>
      <h2>Andy's Contacts</h2>
      <dl className="alt">
        <dt>Phone</dt>
        <dd>805-208-3828</dd>
        <dt>Email</dt>
        <dd>
          <a href="mailto:booking@andymoresi.com">booking@andymoresi.com</a>
        </dd>
      </dl>
      <ul className="icons">
